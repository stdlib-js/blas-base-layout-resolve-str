...
tape( 'the function returns the layout string associated with a BLAS memory layout value', function test( t ) {
	var v;
	var i;
...
tape( 'the function returns `null` if unable to resolve a layout string', function test( t ) {
	var values;
	var i;
